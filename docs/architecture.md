...
| `fal_faceswap.py` | FAL AI `fal-ai/face-swap` | 후처리 전용 (ABC 미구현) |

**FALFaceSwapAdapter**는 생성 어댑터가 아닌 후처리 어댑터로, Worker에 별도 주입된다.
...
| `FAL_FACESWAP_MODEL` | `fal-ai/face-swap` | |
| `BFL_API_KEY` | — | |
